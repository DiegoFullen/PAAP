        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div id="monitor">
                        <iframe id="videoMonitor" src="https://www.youtube.com/embed/u31qwQUeGuM?si=KvOhrHtuXCvr-Pz4" title="VideoPlayer" frameborder="0" allowfullscreen width="100%" height="100%"></iframe>
                    </div>

                    <div id="controls">
                        <button id="optionVideoDefault" class="btn btn-light">Video 1</button>
                        <button id="optionVideo2" class="btn btn-light">Video 2</button>
                        <button id="optionVideo3" class="btn btn-light">Video 3</button>
                    </div>
                </div>
                <!-- /.container-fluid -->
